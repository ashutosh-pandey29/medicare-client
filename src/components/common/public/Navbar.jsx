      ...
      >
        <section className="max-w-[1400px] mx-auto  h-full flex justify-between  items-center py-3">
          ...
          <div className="nav-button flex items-center gap-2">
            <NavLink
              to={"/appointment"}
              className=" text-center cursor-pointer text-lg bg-orange-500 py-3 px-5 rounded-lg text-zinc-50 hover:bg-orange-600 hidden md:block"
            >
              Book Appointment
            </NavLink>
            ...
            <NavLink
              to={"auth"}
              className="hidden md:block cursor-pointer text-lg bg-green-500 py-3 px-5 rounded-lg text-zinc-50 hover:bg-green-600"
            >
              Login
            </NavLink>
