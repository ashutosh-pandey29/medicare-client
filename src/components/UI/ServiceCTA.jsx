        ...
        <div className="text-white text-center md:text-left flex-1 ">
          ...
          <div className="flex flex-col gap-4 mt-5">
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 bg-white text-green-700 px-8 py-4 rounded-xl font-semibold hover:bg-green-50 hover:scale-105 transition-all duration-200 shadow-lg"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 bg-green-700 border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-green-700 transition-all duration-200 shadow-lg"
            >
