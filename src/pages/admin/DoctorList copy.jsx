...
import { MdLockReset, MdOutlineNoAccounts, MdOutlinePublishedWithChanges } from "react-icons/md";
...
export const DoctorList = () => {
  ...
  const searchedData = useMemo(() => {
    ...
    return doctors.filter((d) => d.departmentName.toLowerCase().includes(search.toLowerCase()));
  }, [doctors, search]);
  ...
  return (
    <div className="sm:max-w-sm md:min-w-full mx-auto p-1 h-screen border-5 border-white">
      {/* Heading */}
        ...
        <>
          ...
          <div class="relative  overflow-x-auto ">
            ...
            <div className="px-4 py-3 border-t border-gray-800">
              <Pagination page={page} totalPages={totalPage} onPageChange={setPage} theme="dark" />
            </div>
          </div>
        </>
      )}
